...
<html>
	...
	<body>
		...
		<div>
			...
			<a href="https://goo.gl/maps/CXUPksjTApuMpqJNA">
				<div class="itemCard">
					<h2><center>Address</center></h2>
					<img src="../images/Address.jpg"  > 
				</div>
			</a>
			<a href="tel:+94711594026">
				<div class="itemCard">
					<h2><center>Phone</center></h2>
					<img src="../images/phone.png"  > 
				</div>
			</a>
			<a href="mailto:shalitha97068@gmail.com? subject=subject text">
				<div class="itemCard">
					<h2><center>Email</center></h2>
					<img src="../images/email.jpg"  > 
				</div>
			</a>
			<a href="https://www.facebook.com/Shopping-bag-com-100110465050716/">
				<div class="itemCard">
